...
describe('regular expressions', function () {
  it('1 you should be able to detect a number in a string', function () {
    expect(regexAnswers.containsNumber('abc123')).to.eql(true);
    expect(regexAnswers.containsNumber('abc')).to.eql(false);
  });

  it('2 you should be able to detect a repeating letter in a string', function () {
  ...
  it('3 you should be able to determine whether a string ends with a vowel (aeiou)', function () {
  ...
  it('4 you should be able to capture the first series of three numbers', function () {
  ...
  it('5 you should be able to determine whether a string matches a pattern', function () {
  ...
  it('6 you should be able to detect correctly-formatted monetary amounts in USD', function () {
