...
describe('recursion', function () {
  ...
  it('1 you should be able to return a list of files from the data', function () {
  ...
  it('2 you should be able to return a list of files in a subdir', function () {
...
describe('permutation', function () {
  ...
  it('3 you should be able to return the permutations of an array', function () {
  ...
  it('4 you should be able to return the nth number in a fibonacci sequence', function () {
    expect(recursionAnswers.fibonacci(2)).to.eql(1);
    expect(recursionAnswers.fibonacci(6)).to.eql(8);
  });

  it('5 you should be able to return the set of all valid combinations of n pairs of parentheses.', function () {
    var expected = ['((()))', '(()())', '(())()', '()(())', '()()()'];
