...
describe('numbers', function () {
  describe('binary operations', function () {
    it('1 you should be able to find the value of a given bit', function () {
    ...
    it('2 you should be able to return the base10 representation of a binary string', function () {
      expect(numbersAnswers.base10('11000000')).to.eql(192);
    });

    it('3 you should be able to convert an eight-bit number to a binary string', function () {
  ...
  describe('decimals', function () {
    it('4 you should be able to multiply with precision', function () {
