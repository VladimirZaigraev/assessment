...
describe('arrays', function () {
  ...
  it('1 you should be able to determine the location of an item in an array', function () {
    expect(arraysAnswers.indexOf(a, 3)).to.eql(2);
    expect(arraysAnswers.indexOf(a, 5)).to.eql(-1);
  });

  it('2 you should be able to sum the items of an array', function () {
    expect(arraysAnswers.sum(a)).to.eql(10);
  });

  it('3 you should be able to remove all instances of a value from an array', function () {
  ...
  it('4 you should be able to remove all instances of a value from an array, returning the original array', function () {
    a.splice(1, 0, 2);
    a.push(2);
    a.push(2);
  ...
  it('5 you should be able to add an item to the end of an array', function () {
  ...
  it('6 you should be able to remove the last item of an array', function () {
  ...
  it('7 you should be able to add an item to the beginning of an array', function () {
  ...
  it('8 you should be able to remove the first item of an array', function () {
  ...
  it('9 you should be able to join together two arrays', function () {
    var c = ['a', 'b', 'c', 1];
  ...
  it('10 you should be able to add an item anywhere in an array', function () {
  ...
  it('11 you should be able to count the occurences of an item in an array', function () {
    var result = arraysAnswers.count([1, 2, 4, 4, 3, 4, 3], 4);

    expect(result).to.eql(3);
  });

  it('12 you should be able to find duplicates in an array', function () {
    var result = arraysAnswers.duplicates([1, 2, 4, 4, 3, 3, 1, 5, 3]);

    expect(result.sort()).to.eql([1, 3, 4]);
  });

  it('13 you should be able to square each number in an array', function () {
  ...
  it('14 you should be able to find all occurrences of an item in an array', function () {
